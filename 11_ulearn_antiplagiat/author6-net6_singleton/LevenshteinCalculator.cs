...
namespace Antiplagiarism
{
    ...
    {
        private static LevenshteinCalculator? instance = null;
        
        private LevenshteinCalculator() { }

        public static LevenshteinCalculator GetInstance()
        {
            if (instance == null) instance = new LevenshteinCalculator();
            return instance;
        }
