...
namespace Antiplagiarism
{
    ...
    {
        public static IEnumerable<string> LoadSituationFromFolder(DirectoryInfo folder, string documentName)
        {
        ...
        public static IEnumerable<string> LoadAllSituationsNames(DirectoryInfo folder)
        {
