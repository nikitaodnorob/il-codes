namespace Rectangles
{
    ...
    {
        private static RectangleCounter? instance = null;
        
        private RectangleCounter() { }

        public static RectangleCounter GetInstance()
        {
            if (instance == null) instance = new RectangleCounter();
            return instance;
        }
        ...
        private void CalcMinMax(Rectangle r1, Rectangle r2, out int left, out int right, out int top, out int bottom)
        {
